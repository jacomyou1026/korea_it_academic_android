...
public class
AddressRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtTel = findViewById(R.id.edit_tell);
        btnAdd = findViewById(R.id.register_edt_add);
        btnCancel = findViewById(R.id.register_cancel);
